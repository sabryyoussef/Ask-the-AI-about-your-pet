...
SECRET_KEY = 'django-insecure-#)po7x&2$=l6_85%de!j-l#-u4uwo5xae$*n=6t#v)!w-vu$@z'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'symptom_checker/templates')],  # Add the template directory
        'DIRS': [],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
